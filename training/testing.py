...
if __name__ == "__main__":
    ...
    train_path = "../data/Cell_Phones_and_Accessories_5/train.txt"
    test_path = "../data/Cell_Phones_and_Accessories_5/test.txt"
    ...
    user_id_list0=["A1E1LEVQ9VQNK","A1EVV74UQYVKRY","A1F7YU6O5RU432","A1ODOGXEYECQQ8","A1PI8VBCXXSGC7","A1U11IP6K6NHAK","A1UQBFCERIP7VJ","A1W415JP5WEAJK","A2BLFCOPSMBOZ9","A2BYV7S1QP2YIG",
    ...
    for i in range(len(user_id_list)):
        '''
        most_f.append(top_feature(5,user_id_list[i],user_id_list[0],X_, X_x, user_index, aspect_index, user_index2))
        most_f_15.append(top_feature(15,user_id_list[i],user_id_list[0],X_, X_x, user_index, aspect_index, user_index2))
        most_f_25.append(top_feature(25,user_id_list[i],user_id_list[0],X_, X_x, user_index, aspect_index, user_index2))
        most_f_35.append(top_feature(35,user_id_list[i],user_id_list[0],X_, X_x, user_index, aspect_index, user_index2))
        most_f_40.append(top_feature(40,user_id_list[i],user_id_list[0],X_, X_x, user_index, aspect_index, user_index2))
        '''
    ...
    '''
    most_f_random = top_feature_random(user_i,user_id_list[0],X_, X_x, user_index, aspect_index, user_index2)
    random.shuffle(X_[user_i, :])
    most_f_random2 = top_feature_random(user_i,user_id_list[0],X_, X_x, user_index, aspect_index, user_index2)
    random.shuffle(X_[user_i, :])
    most_f_random3 = top_feature_random(user_i,user_id_list[0],X_, X_x, user_index, aspect_index, user_index2)
    random.shuffle(X_[user_i, :])
    most_f_random4 = top_feature_random(user_i,user_id_list[0],X_, X_x, user_index, aspect_index, user_index2)
    random.shuffle(X_[user_i, :])
    most_f_random5 = top_feature_random(user_i,user_id_list[0],X_, X_x, user_index, aspect_index, user_index2)
    random.shuffle(X_[user_i, :])
    most_f_random6 = top_feature_random(user_i,user_id_list[0],X_, X_x, user_index, aspect_index, user_index2)
    random.shuffle(X_[user_i, :])
    most_f_random7 = top_feature_random(user_i,user_id_list[0],X_, X_x, user_index, aspect_index, user_index2)
    random.shuffle(X_[user_i, :])
    most_f_random8 = top_feature_random(user_i,user_id_list[0],X_, X_x, user_index, aspect_index, user_index2)
    random.shuffle(X_[user_i, :])
    most_f_random9 = top_feature_random(user_i,user_id_list[0],X_, X_x, user_index, aspect_index, user_index2)
    random.shuffle(X_[user_i, :])
    most_f_random10 = top_feature_random(user_i,user_id_list[0],X_, X_x, user_index, aspect_index, user_index2)
    '''
    ...
    #print('most_f_random=\n'+str(most_f_random))
    print('most_f_15=\n'+str(most_f_15))
    #print('most_f_random_15=\n'+str(most_f_random_15))
    print('most_f_25=\n'+str(most_f_25))
    #print('most_f_random_25=\n'+str(most_f_random_25))
    print('most_f_35=\n'+str(most_f_35))
    #print('most_f_random_35=\n'+str(most_f_random_35))
    print('most_f_40=\n'+str(most_f_40))
    '''
    print('most_fcount=\n'+str(most_fcount))
